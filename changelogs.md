...
tile images in loader2.py under the tiles comment (as of right now line 19)
actual blitting of the tiles in draw_dungeon() function in loader3.py (as of right now line 265)
...
made some mutation function
made some weapon info
...
make save icon
show saving icon, heh

make save data work with something
make framerates sync with data
...
i think save is kind of broken from loader 3 same thing with hints
